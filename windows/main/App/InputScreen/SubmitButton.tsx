...
export function SubmitButton({
  ...
  const GREY_BG =
    'bg-[#DDD] text-[#666666] hover:bg-[#DDD] border-[#666666] dark:bg-neutral-700/50 dark:text-white/70 dark:hover:bg-neutral-700/50 dark:border-[#6b7280]'
  ...
  return (
    <Button
      className={twMerge(
        'relative w-full h-[34px]  text-[15px] px-6 flex items-center transition-all justify-center rounded-md track-10 disabled:!opacity-100 disabled:!cursor-not-allowed',
        bgClassName,
