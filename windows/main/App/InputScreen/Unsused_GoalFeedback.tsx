      ...
      inner = (
        <div className="p-2">
          <motion.div
            ...
            className="p-[8px] py-1 rounded-[4px] bg-[#ceffe3] border border-[#D29000] text-[#A57100] track-10 text-[14px] leading-[19px]"
          >
      ...
      inner = (
        <div className="p-2">
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.4 }}
            className="p-[8px] py-1 rounded-[4px] bg-[#FFF0CE] border border-[#D29000] text-[#A57100] track-10 text-[14px] leading-[19px]"
          >
